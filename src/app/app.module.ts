...
import { CompraConsultarComponent } from 'src/pages/compra-consultar/compra-consultar';
...
const appRoutes: Routes = [
  ...
  {
    path: 'compra-consultar',
    component: CompraConsultarComponent
  },
  {
